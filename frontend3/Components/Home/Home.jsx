    ...
    <>
          ...
          >
            ...
            >
              ...
              <VStack gap={8} w="100%" align={{ base: "center", lg: "flex-start" }}>
                ...
                >
                  Learn <Icon as={BiChevronRight} verticalAlign="middle" boxSize={6} /> Practice <Icon as={BiChevronRight} verticalAlign="middle" boxSize={6} /> Improve <Icon as={BiChevronRight} verticalAlign="middle" boxSize={6} /> Succeed
                </Box>
                <Button
      ...
      >
        ...
        <Tabs variant='soft-rounded' colorScheme='green' mb={5} >
          ...
          <Box>
              <Menu>
                  <MenuButton as={Button} rightIcon={<BiChevronRight />} w="80%">
                      SSC GD Constable
                  </MenuButton>
              </Menu>
          </Box>
          ...
          >
            ...
            >
              ...
              <VStack gap={8} w="100%" align={{ base: "center", lg: "flex-start" }}>
                ...
                >
                  Get unlimited access to the most relevant Mock Tests, on India's #1 Online Test Series Platform
                </Box>
                <SimpleGrid
              columns={["2", "2"]}
              direction={["column", "row"]}
