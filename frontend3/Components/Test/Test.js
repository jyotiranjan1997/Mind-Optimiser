...
export default function Test() {
  ...
  return (
    <Box w="90%" m="auto">
      <Box ml="90%">
        {/* <Counter hours ="00" minutes={14} seconds={59}  /> */}
      </Box>
      {/* <ControlledCarousel/> */}
      <Flex
        w={["90%", "70%", "50%", "50%"]}
      ...
      <Box mt="45px">
        ...
        <Text>
          ...
          attempting the SSC Reasoning Pack Test Series. We hope you found this
            article on the SSC Reasoning Pack helpful and informative.</Flex>
          <Flex
            gap="8px"
            mb="5px"
            fontSize={["9px", "9px", "15px", "15px"]}
          ...
          >
            <input type="checkbox" disabled={true} />
          <br /> You can also download our Testbook App and start preparing for
            various government exams.</Flex>
          <br />
          <Flex
            gap="8px"
            mb="5px"
          ...
          Series, Mock tests, PDFs, live coaching sessions, etc.</Flex>
        </Text>
      </Box>
    </Box>
  );
